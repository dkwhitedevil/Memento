      ...
      <>
        ...
        <main className="min-h-screen bg-white text-black font-sans overflow-hidden relative">
          <nav className="border-b-4 border-black px-6 py-4 flex items-center justify-between relative z-10">
            ...
            <div className="border-4 border-black px-5 py-2 font-bold shadow-[6px_6px_0px_#000]">
              Loading...
            </div>
          </nav>
        </main>
      ...
      {/* FEATURES */}
        ...
        <section className="px-6 py-28 border-t-4 border-black text-center space-y-10 relative overflow-hidden">
          ...
          <button 
            ...
            className={`border-4 border-black px-12 py-6 text-2xl font-black shadow-[12px_12px_0px_#000] hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all duration-300 hover-lift relative overflow-hidden group ${
            isLoaded ? 'animate-bounce-in' : 'opacity-0'
